...
public class InventoryServiceImpl implements InventoryService {
    ...
    public InventoryProductDTO getProduct(String hawa) {
        try {
            ...
            log.error("Error obteniendo producto {}: {}", hawa, e.getMessage());
            throw new ServicesException("Error consultando inventario: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public AvailabilityResponseDTO checkAvailability(String hawa) {
        try {
            ...
            log.error("Error verificando disponibilidad {}: {}", hawa, e.getMessage());
    ...
    public boolean decrementStock(String hawa, Integer quantity) {
        try {
            ...
            log.error("Error decrementando stock {}: {}", hawa, e.getMessage());
            return false;
        }
    }
    ...
    public boolean incrementStock(String hawa, Integer quantity) {
        try {
            ...
            log.error("Error incrementando stock {}: {}", hawa, e.getMessage());
            return false;
        }
    }
}
